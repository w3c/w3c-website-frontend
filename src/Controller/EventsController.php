...
class EventsController extends AbstractController
{
    ...
    #[Route(
        ...
        requirements: ['type' => 'ac|conferences|happenings|meetups|talks|tpac|workshops']
    )]
    ...
    #[Route(
        ...
        requirements: ['type' => 'ac|conferences|happenings|meetups|talks|tpac|workshops', 'year' => '\d\d\d\d']
    )]
